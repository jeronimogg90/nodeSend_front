...
const Dropzone = () => {
    ...
    // Usamos useCallback para evitar el re-rendering
    //Se ejecuta cuando sueltas un archivo
  ...
  return (
    <div className='md:flex-1 mb-3 mx-2 mt-16 lg:mt-0 flex flex-col 
        items-center justify-center border-dashed border-gray-400 
        border-2 bg-gray-100 px-4'>
        ...
        { acceptedFiles.length > 0 ? (
            <div className='mt-10 w-full'>
                ...
                { cargando ? <p className='my-10 text-center text-gray-600'>Subiendo archvio...</p> : (
                    <button
                        onClick={ () => crearEnlace() }
                        type="button"
                ...
                <input className='h-100 ' {...getInputProps()} />

                    {
                        ...
                        <div className='text-center'>
                            <p className='text-2xl text-center text-gray-600'>Seleccione un archivo o arrastralo aquí</p>
